                        ...
                        <div id="wizard">
                            <section>
                                ...
                                <div class="form-group">
                                    <div class="row mt-5">
                                        <div class="col-5">
                                            <label for="code">Add Post<span style={{ color: "red" }}><sup>*</sup></span></label>
                                        </div>
                                        <div class="col-6">
                                            <FileBase64
                                                type="file"
                                ...
                                <div class="form-group">
                                    <div className="row mt-5">
                                        <div class="col-5">
                                            <label for="name">Add Description for your post
                                ...
                                <div class="form-group">
                                    <div class="row mt-5">
                                        <div class="col-5">
                                            <label for="code">Tag Location<span style={{ color: "red" }}><sup>*</sup></span></label>
                                        </div>
